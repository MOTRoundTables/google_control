...
IN_SHP    = r"runs/1_10_25/input/maps/basemap/30_09_2025_base_map/final_version_300925_golan_format.shp"           # input layer with geometry and a keta-like id field
...
OUT_SHP   = r"runs/1_11_25/input/maps/basemap/azimut_base_map/30_9_2025_base_map_azimut_id.shp"   # original geometry + Id only
CROW_SHP  = r"runs/1_11_25/input/maps/basemap/azimut_base_map/30_9_2025_base_map_crow_only.shp" # crow-line geometry + Id only
OUT_XLSX  = r"runs/1_11_25/input/maps/basemap/azimut_base_map/30_9_2025_a_b.xlsx"        # Excel with Hebrew headers
